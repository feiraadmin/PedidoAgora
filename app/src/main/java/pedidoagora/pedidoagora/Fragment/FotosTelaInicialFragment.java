package pedidoagora.pedidoagora.Fragment;
...
public class FotosTelaInicialFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        StorageReference storageReference = storage.getReferenceFromUrl("gs://meuappfirebase-85bc9.appspot.com/").child("feira.jpg");
